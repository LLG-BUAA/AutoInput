...
class Tool(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        with self.titled_widgets_group as group:
            ...
            self.demo_label1 = SiLabel(self)
            self.demo_label1.setSiliconWidgetFlag(Si.AdjustSizeOnTextChanged)
            self.demo_label1.setText("测试标签1")
            self.demo_label2 = SiLabel(self)
            self.demo_label2.setSiliconWidgetFlag(Si.AdjustSizeOnTextChanged)
            self.demo_label2.setText("测试标签2")
            self.demo_label3 = SiLabel(self)
            self.demo_label3.setSiliconWidgetFlag(Si.AdjustSizeOnTextChanged)
            self.demo_label3.setText("测试标签3")
            ...
            self.label_for_text.body().addWidget(self.demo_label1)
            self.label_for_text.body().addWidget(self.demo_label2)
            self.label_for_text.body().addWidget(self.demo_label3)
